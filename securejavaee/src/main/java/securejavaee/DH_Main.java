...
public class DH_Main {
    public static void main(String[] args) throws Exception {
        ...
        KeyPairGenerator bobKeyPairGenerator = KeyPairGenerator.getInstance("DH"); //Get a DH KeyPairGenerator
        bobKeyPairGenerator.initialize(sharedModulusAndBase, new SecureRandom());  //DH initialization based on shared modulus/base
        KeyPair bobKeyPair = bobKeyPairGenerator.generateKeyPair();  // generates his keys
        KeyAgreement bobKeyAgreement = KeyAgreement.getInstance("DH"); //Create a Key Agreement to
        ...
        System.out.println("Bobs Public Key: " + bobPublicKey.getY());
