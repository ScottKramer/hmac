package com.chicagocoderconference.lessons;
...
@Path("/jerseyhmaclesson")
public class ALesson_JerseyHMACSimulatorFix {
	...
	public String makeHTTPCallUsingHMAC(
		...
		final String hmacRESTMicroserviceUrl = "http://localhost:9998/jerseyhmaclesson/receive";
